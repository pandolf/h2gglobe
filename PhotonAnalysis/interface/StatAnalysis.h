...
class StatAnalysis : public PhotonAnalysis 
{
 ...
 protected:
    ...
    int diphotonVBF_id, diphotonVHhad_id, diphotonVHlep_id, diphotonVHmet_id,diphotonVHhadBtag_id,diphotonTTHhad_id,diphotonTTHlep_id, diphotontHqLeptonic_id, diphotontHqHadronic_id;
    bool VHmuevent, VHelevent, VBFevent, VHhadevent,VHhadBtagevent, VHmetevent,TTHhadevent,TTHlepevent,tHqLeptonicevent,tHqHadronicevent;  //met at analysis step 
